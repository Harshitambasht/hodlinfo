    ...
    return (
        <React.Fragment>
            ...
            <div class="Container-fluid " style={{ padding: "0px 30px" }}>
                ...
                <a target="_blank" rel="noreferrer" href="https://finstreet.in/">
                    <img src="cryptonews.png" alt="img" style={{ width: "100%", padding: "0px 0px 20px" }} />
                </a>
            </div>
                    ...
                    <tbody>
                        <tr>
                            ...
                            <td class="align-middle"><a target="_blank" href="">
                                <h4 class="table-text"><img src="wazix.png" alt="img" class="exchange-logo" ></img> <span class="exchange-name ">WazirX</span></h4>
