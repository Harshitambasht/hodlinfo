                ...
                <div class="text-center-sm col-12 col-sm-7 col-md-5 col-lg-4">
                    <a href="/">
                        <div class="padding-none text-center-xs col-12 col-sm-12 col-md-11 col-lg-11">
                            <img src="hodlinfo_logo.png" alt="img" class="fiat-logo" style={{padding: "10px"}} />
                        </div>
                    </a>
                    <p class="col-12 text-center-xs" style={{"font-family": "Oswald, sans-serif", "margin-top": "-18px", opacity: "0.8", "font-size": "18px", color: "gray"}}>Powered By <a class="footer-text-link" rel="noreferrer" target="_blank" href="https://www.finstreet.in/" style={{color: "rgb(61, 198, 193)"}}> Finstreet </a>
                    </p>
                </div>
                        ...
                        <a class="color-white" href="/connect/telegram">
                            <div class="d-flex telegram-logo-text header-telegram-button btn align-items-center pointer color-white">
                                <div class="d-inline-block">
                                    <img src="telegram.png" alt="img" class="telegram-logo" /></div>
